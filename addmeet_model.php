...
$meetfilelocation=$fileDes;
	...
	mysqli_query($conn,"insert into meeting (title, head, numattend, listname, roomid, start, end, addequipment, remark, meetfile) values 
	('$title', '$head', '$numattend', '$listname', '$roomid', '$start', '$end', '$addequipment', '$remark', '$meetfile')");
	header('location:addmeet.php');

	// mysqli_query($conn,"insert into meeting (title, roomid, meetfile) values 
	// ('$title', '$roomid', '$meetfile')");
	// header('location:addmeet.php');
