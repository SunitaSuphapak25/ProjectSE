            ...
            <div class="modal-content">
				...
				<form method="POST" action="editroom.php?roomid=<?php echo $erow['roomid']; ?>">
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" class="form-control" name="capacity" value="<?php echo $erow['capacity']; ?>">
						</div>
					</div>
                    <div style="height:10px;"></div>
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" class="form-control" name="projector" value="<?php echo $erow['projector']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
					<div class="row">
						<div class="col-lg-2">
							<label class="control-label" style="position:relative; top:7px;">จำนวนไมโครโฟน:</label>
						</div>
						<div class="col-lg-10">
							<input type="text" class="form-control" name="microphone" value="<?php echo $erow['microphone']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" class="form-control" name="other" value="<?php echo $erow['other']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
